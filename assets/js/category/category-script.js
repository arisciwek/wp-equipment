...
(function($) {
   ...
   handleLoadError() {
    ...
    function checkLastCategoryError() {
        const lastCheckedId = localStorage.getItem('last_category_access_check');
        const errorData = localStorage.getItem('category_access_error');
        ...
        if (lastCheckedId) {
            ...
            // Clear storage setelah dibaca
            localStorage.removeItem('last_category_access_check');
